...
const HomePage = (props) => {
  ...
  return (
    <GeneralLayout>
      ...
      >
        ...
        >
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            <h2
              className="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl sm:leading-none"
            >
            ...
            <div className="flex items-center">
              ...
              <a
                href="/"
                aria-label=""
                className="inline-flex items-center font-semibold text-gray-800 transition-colors duration-200 hover:text-gray-800"
              >Learn more</a
              >
            </div>
          </div>
      ...
      <div
        className="px-4 py-16 bg-gray-300 mx-auto w-full md:px-24 lg:px-8 lg:py-20"
      >
        <div className="flex flex-col max-w-4xl mx-auto mb-6 lg:flex-row md:mb-10">
          <div className="lg:w-1/2">
            <h2
              className="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl sm:leading-none xl:max-w-lg"
            >
        ...
        <div
          className="grid max-w-4xl gap-8 row-gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-2"
        >
          <div className="max-w-md">
            <div
              className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-red-100"
            >
              <svg
                stroke="currentColor"
                viewBox="0 0 52 52"
      ...
      <div
        className="px-4 py-16 mx-auto md:px-24 lg:px-8 lg:py-20 w-full bg-gray-300"
      >
        <div
        ...
        >
          <div>
            <p
              className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-red-600"
            >
              Brand new
          </p>
          </div>
          <h2
            className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-800 sm:text-4xl md:mx-auto"
          >
          ...
          <p className="text-base text-gray-800 md:text-lg">
            ...
            best quality materials starting from 4" to 6" and ranging from 500 PSI to 1000 PSI
        </p>
        </div>
        <div
          className="grid max-w-md gap-10 row-gap-8 lg:max-w-screen-lg sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-lg sm:mx-auto"
        >
          <div
          ...
          >
            ...
            <div
              className="flex flex-col justify-between flex-grow p-8 border border-t-0 rounded-b"
            >
              <div>
                <div className="text-lg font-semibold">Concrete Hollow Block 4"</div>
          ...
          >
            ...
            >
              <div>
                <div className="text-lg font-semibold">Concrete Hollow Block 5"</div>
                <p className="text-sm text-gray-700">
                  This size of hollow blocks can be used for residential and commercial building
              </p>
                <div className="mt-3 mb-4 mr-1 text-4xl font-bold sm:text-4xl">
                  14.50 PHP
              </div>
          ...
          >
            ...
            >
              <div>
                <div className="text-lg font-semibold">Concrete Hollow Block 6"</div>
                <p className="text-sm text-gray-700">

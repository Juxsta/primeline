      ...
      <div className="max-w-6xl mx-auto grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              ...
              className="transition-colors duration-300 text-red-800 hover:text-deep-purple-800"
            >
              0997 436 9830
            </a>
          </div>
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a
              href="/"
              className="text-gray-800 transition-colors duration-300 hover:text-red-800"
            >

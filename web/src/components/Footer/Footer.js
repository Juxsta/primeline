const Footer = () => {
  return (
    <div className="bg-gray-400 px-4 pt-16 mx-auto w-full border-opacity-10 md:px-24 lg:px-8">
      <div className="max-w-6xl mx-auto grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            <img src="/Primeline Logo.svg" height="250" width="250" />
          </a>
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            <p className="mr-1 text-gray-800">Global Phone:</p>
            <a
